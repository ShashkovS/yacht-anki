...
var dbPath = process.env.E2E_DB_PATH && process.env.E2E_DB_PATH.trim() ? process.env.E2E_DB_PATH.trim() : path.join(dbDir, "templatepwa-e2e-".concat(Date.now(), "-").concat(process.pid, ".sqlite3"));
